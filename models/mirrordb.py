...
#            typeL2 = typeL2), where = 'typeL1=$typeL1 and typeL2=$typeL2', order = 'hotrank DESC, fetch_time DESC', limit=limit).list()            
        ...
        sql_query = 'select * from ' + alldbname +  ' where typeL1="' + typeL1 + '" and typeL2="' + typeL2 + '" order by hotrank DESC limit ' + str(perpage) + ' offset ' + str(offset)
        sql_query_count = 'select COUNT(*) AS count from ' + alldbname +  ' where typeL1="' + typeL1 + '" and typeL2="' + typeL2 + '"'
    else:
        sql_query = 'select * from ' + alldbname +  ' where typeL1="' + typeL1 + '" order by hotrank DESC limit ' + str(perpage) + ' offset ' + str(offset) 
    ...
    records_count = total_count_limit
...
def get_hot_types():
    ...
    sql_query = 'select typeL1,typeL2,avg(hotrank) from all_resource where hotrank<>0 and typeL1<>"" group by typeL2 limit ' + str(hot_tags)
